...
namespace ArmaSOGClient
{
    internal class DBHandler : IDisposable
    {
        ...
        private static readonly string DbPath = Path.Combine(ASC_DBFolder, "asc_player.db");
        ...
        private void InitializeLiteDB()
        {
            ...
            if (!Directory.Exists(dbDir))
            {
                ...
                DllEntry.ASC_Actionlog($"Created directory at: {dbDir}");
            }

            var dbStr = $"Filename = {DbPath}; Password = xyz123; Connection Type = Shared;";
            _db = new LiteDatabase(dbStr);
