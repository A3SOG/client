/*
	Name:	sog_client_medical_fnc_spawnVictim
	Date:	8/6/2022
	Version: 1.0
	Author:  J. Schmidt
...
[victim0, _typeOfWound] call sog_client_medical_fnc_checkVictim;
[victim0, ["End Practice Case", sog_client_medical, {[victim0] call sog_client_medical_fnc_deleteVictim}]] remoteExec ["addAction", 0];
