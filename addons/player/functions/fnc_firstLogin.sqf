...
uiSleep 1;
["listrng", player getVariable ["SOG_Phone_Number", "unknown@spearnet.mil"], "", -1, [], "sog_client_phone_fnc_addMsg", netId player, true] remoteExec ["dragonfly_db_fnc_addTask", 2, false];